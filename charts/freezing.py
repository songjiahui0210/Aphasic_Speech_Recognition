...
plt.scatter(valid_layers[5], valid_wer[5], color="#A4804A", s=60, label="lowest Point")
plt.text(valid_layers[5]+0.5, valid_wer[5]-0.3, f'{valid_wer[5]:.2f}', fontsize=fontsize_ticks, ha='left', color="#A4804A")
plt.text(valid_layers[5]+5.5, valid_wer[5]-1, f'Layers 1 to {valid_layers[5]} frozen', fontsize=fontsize_ticks, ha='right', color="#A4804A")

# Plot the rest of the dots in black
other_layers = valid_layers[1:5] + valid_layers[6:]
other_wer = valid_wer[1:5] + valid_wer[6:]
